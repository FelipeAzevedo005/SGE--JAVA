...
public class ListarDespesas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Confecção de santinhos para panfletagem", "1,000,00", "356.241.463.-67", "05/08/2018"},
                {"Bottons", "350,00", "581.753.252-85", "10/11/2018"},
                {null, null, null, null},
                {null, null, null, null}
            },
            new String [] {
                "Descrição da despesa", "Valor", "CPF do doador", "Data de doação"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel1.setText("Listagem de despesas");
